...
module nft_addr::test_nft {
    ...
    public entry fun test_metadata_mapping(creator: &signer) {
        ...
        let retrieved_token_id = nft::get_nft_id_by_hash(metadata); // Remove &
    ...
    public entry fun test_get_non_existent_nft(creator: &signer) {
        ...
        assert!(nft::exists_metadata_map(), 1);
        ...
        let _token_id = nft::get_nft_id_by_hash(non_existent_metadata); // Remove &
    }
}
